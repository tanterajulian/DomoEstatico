...
left_image_path = '/home/nvidia/DomoEstatico/DomoPC/left_image.jpg'
right_image_path = '/home/nvidia/DomoEstatico/DomoPC/right_image.jpg'
...
def bot_mensajes_texto(message):
    ...
    if comando == "/start":
        ...
        archivo = open("/home/nvidia/DomoEstatico/DomoPC/logDomo.txt", "rb")
...
def iniciar_observador():
    ...
    observer.schedule(event_handler, path="/home/nvidia/DomoEstatico/DomoPC/", recursive=False)
    observer.start()
    try:
        while True:
            time.sleep(1)
